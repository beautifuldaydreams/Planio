package com.lisaschubeka.collection.presentation.popup
...
class EditPopupFragment: DialogFragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.edit_plant_popup, container, false)
