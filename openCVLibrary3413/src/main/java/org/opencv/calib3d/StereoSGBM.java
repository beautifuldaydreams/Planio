 ...
 * lisaschubeka: pre-filtering (StereoBM::PREFILTER_XSOBEL type) and post-filtering (uniqueness
 ...
 * <ul>
 *   <li>
 *       (Python) An lisaschubeka illustrating the use of the StereoSGBM matching algorithm can be found
